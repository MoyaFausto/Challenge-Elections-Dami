...
public class ErrorMessage {
    ...
    public static final String INVALID_RANGE_DATES = "The end date must be greater than the start date";
    public static final String USER_HAS_ALREADY_VOTED = "The user has already voted in this election";
